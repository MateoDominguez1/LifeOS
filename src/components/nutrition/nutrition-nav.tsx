...
const primaryTabs = [
  { href: "/nutrition", label: "Hoy", icon: LayoutDashboard },
  { href: "/nutrition/add", label: "Analizar", icon: Camera },
  { href: "/nutrition/history", label: "Historial", icon: CalendarDays },
];
...
const moreGroups = [
  {
    label: "Seguimiento",
    items: [
      { href: "/nutrition/progress", label: "Progreso", icon: LineChart },
      { href: "/nutrition/profile", label: "Perfil y objetivos", icon: User },
    ],
  },
  {
    label: "Alimentos",
    items: [
      { href: "/nutrition/foods", label: "Buscar alimentos", icon: Apple },
      { href: "/nutrition/recipes", label: "Recetas", icon: ChefHat },
    ],
  },
];
...
export function NutritionNav() {
  ...
  const isActive = (href: string) => (href === "/nutrition" ? pathname === "/nutrition" : pathname.startsWith(href));
        ...
        return (
          <Link
            ...
            className={cn(
              ...
              active ? "bg-nutrition-soft text-nutrition" : "text-ink-soft hover:bg-surface-raised hover:text-ink"
            )}
          >
