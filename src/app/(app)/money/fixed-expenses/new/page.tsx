...
export default async function NewFixedExpensePage() {
  ...
  return (
    <div className="mx-auto max-w-md">
      ...
      <Card className="p-6">
        <h1 className="mb-4 font-display text-lg font-bold">Nuevo gasto fijo</h1>
        {accounts.length === 0 ? (
          ...
          <FixedExpenseForm action={createFixedExpenseAction} accounts={accounts} categories={categories} />
        )}
      </Card>
    </div>
  );
