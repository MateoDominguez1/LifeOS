...
export default async function NewTransactionPage() {
  ...
  return (
    <div className="mx-auto max-w-md">
      ...
      <Card className="p-6">
        <h1 className="mb-4 font-display text-lg font-bold">{t.money.transactions.newTransaction}</h1>
        {accounts.length === 0 ? (
          ...
          <TransactionForm action={createTransactionAction} accounts={accounts} categories={categories} t={t} />
        )}
      </Card>
    </div>
  );
